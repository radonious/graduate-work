...
fun main() {
    ...
    val result = tokensAnalyzeDetails(tokens1, tokens2)
    val result2 = tokensAnalyzeDetails(tokens1, tokens3)

    println("\ncode1 and code2")
    result.forEach { (metric, value) -> println("$metric: $value") }
    println(tokensAnalyzeFinalScore(tokens1, tokens2))

    println("\ncode1 and code3")
    result2.forEach { (metric, value) -> println("$metric: $value") }
    println(tokensAnalyzeFinalScore(tokens1, tokens3))
}